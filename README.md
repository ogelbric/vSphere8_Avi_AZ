...
$VCSAInstallerPath = "G:\"      # G is vSphere 8
...
$NestedESXiHostnameToIPs = @{
    "avi-esxi-1" = "192.168.1.51"
    "avi-esxi-2" = "192.168.1.52"
    "avi-esxi-3" = "192.168.1.53"
    "avi-esxi-4" = "192.168.1.41"
    "avi-esxi-5" = "192.168.1.42"
    "avi-esxi-6" = "192.168.1.43"
    "avi-esxi-7" = "192.168.1.44"
    "avi-esxi-8" = "192.168.1.45"
    "avi-esxi-9" = "192.168.1.46"
}

# Nested ESXi VM Resources
$NestedESXivCPU = "10"
$NestedESXivMEM = "65" #GB
...
$VMPassword = "VMware1!"
$VMDomain = "lab.local"
$VMSyslog = "192.168.1.50"
$VMFolder = "Project-AVI"
# Applicable to Nested ESXi only
$VMSSH = "true"
$VMVMFS = "false"

#TKGI console setup
$TKGIDatastore = "vsanDatastore"
...
$NewVCVSANClusterName = "avi-Cluster0"
$NewVCVSANClusterName1 = "avi-Cluster1"
$NewVCVSANClusterName2 = "avi-Cluster2"
$NewVCVSANClusterName3 = "avi-Cluster3"

$NewVCVDSName = "Pacific-VDS"
$NewVCDVPGName1 = "DVPG-Management Network"
$NewVCDVPGName2 = "DVPG-Frontend Network"
$NewVCDVPGName3 = "DVPG-Workload Network"
...
$debug = $true
$verboseLogFile = "AVI-deploymenttkgi.log"
$random_string = -join ((65..90) + (97..122) | Get-Random -Count 8 | % {[char]$_})
$VAppName = "AVI-Nested-Lab-$random_string"
...
#“prop:guestinfo.cis.feature.states”: “WCP_Unified_TKG=enabled”    only for non GA version!!!!!!

        $featureFlags = [pscustomobject] @{
#            "prop:guestinfo.cis.feature.states" = "NSX_Integrated=disabled";
            "prop:guestinfo.cis.feature.states" = "WCP_Unified_TKG=enabled";
...
if($setupNewVC -eq 1) {
    ...
    $d = Get-Datacenter -Server $vc -ErrorAction Ignore
    if( -Not $d) {
...
#    }
    ...
    $c = Get-Cluster -Server $vc $NewVCVSANClusterName1 -ErrorAction Ignore
    if( -Not $c) {
        My-Logger "Creating VSAN Cluster $NewVCVSANClusterName1 ..."
        New-Cluster -Server $vc -Name $NewVCVSANClusterName1 -Location (Get-Datacenter -Name $NewVCDatacenterName -Server $vc) -DrsEnabled -HAEnabled -VsanEnabled | Out-File -Append -LiteralPath $verboseLogFile
        (Get-Cluster $NewVCVSANClusterName1) | New-AdvancedSetting -Name "das.ignoreRedundantNetWarning" -Type ClusterHA -Value $true -Confirm:$false -Force | Out-File -Append -LiteralPath $verboseLogFile
    }
    $c = Get-Cluster -Server $vc $NewVCVSANClusterName2 -ErrorAction Ignore
    if( -Not $c) {
        My-Logger "Creating VSAN Cluster $NewVCVSANClusterName2 ..."
        New-Cluster -Server $vc -Name $NewVCVSANClusterName2 -Location (Get-Datacenter -Name $NewVCDatacenterName -Server $vc) -DrsEnabled -HAEnabled -VsanEnabled | Out-File -Append -LiteralPath $verboseLogFile
        (Get-Cluster $NewVCVSANClusterName2) | New-AdvancedSetting -Name "das.ignoreRedundantNetWarning" -Type ClusterHA -Value $true -Confirm:$false -Force | Out-File -Append -LiteralPath $verboseLogFile
    }
    $c = Get-Cluster -Server $vc $NewVCVSANClusterName3 -ErrorAction Ignore
    if( -Not $c) {
        My-Logger "Creating VSAN Cluster $NewVCVSANClusterName3 ..."
        New-Cluster -Server $vc -Name $NewVCVSANClusterName3 -Location (Get-Datacenter -Name $NewVCDatacenterName -Server $vc) -DrsEnabled -HAEnabled -VsanEnabled | Out-File -Append -LiteralPath $verboseLogFile
        (Get-Cluster $NewVCVSANClusterName3) | New-AdvancedSetting -Name "das.ignoreRedundantNetWarning" -Type ClusterHA -Value $true -Confirm:$false -Force | Out-File -Append -LiteralPath $verboseLogFile
    }
#
# $NestedESXiHostnameToIPs.GetEnumerator() | Sort-Object -Property Value -Top 9 | Sort-Object -Property Value -Bottom 3
#
    if($addESXiHostsToVC -eq 1) {
        $NestedESXiHostnameToIPs.GetEnumerator() | Sort-Object -Property Value -Top 3 | Sort-Object -Property Value -Bottom 3| Foreach-Object {
            $VMName = $_.Key
            $VMIPAddress = $_.Value
			...
			$orf1 = (Get-Cluster -Name $NewVCVSANClusterName1).Name | Select-Object -first 1
            ...
            #Add-VMHost -Server $vc -Location (Get-Cluster -Name $NewVCVSANClusterName1) -User "root" -Password $VMPassword -Name $targetVMHost -Force | Out-File -Append -LiteralPath $verboseLogFile
        }
    }

    if($addESXiHostsToVC -eq 1) {
        $NestedESXiHostnameToIPs.GetEnumerator() | Sort-Object -Property Value -Top 6 | Sort-Object -Property Value -Bottom 3| Foreach-Object {
            $VMName = $_.Key
            $VMIPAddress = $_.Value
			...
			$orf1 = (Get-Cluster -Name $NewVCVSANClusterName2).Name | Select-Object -first 1
            My-Logger "Adding ESXi host $targetVMHost to Cluster ...$orf1"
            Add-VMHost -Server $vc -Location $orf1 -User "root" -Password $VMPassword -Name $targetVMHost -Force | Out-File -Append -LiteralPath $verboseLogFile
            #Add-VMHost -Server $vc -Location (Get-Cluster -Name $NewVCVSANClusterName2) -User "root" -Password $VMPassword -Name $targetVMHost -Force | Out-File -Append -LiteralPath $verboseLogFile
        }
    }


    if($addESXiHostsToVC -eq 1) {
        $NestedESXiHostnameToIPs.GetEnumerator() | Sort-Object -Property Value -Top 9 | Sort-Object -Property Value -Bottom 3| Foreach-Object {
            $VMName = $_.Key
            $VMIPAddress = $_.Value
			...
			$orf1 = (Get-Cluster -Name $NewVCVSANClusterName3).Name | Select-Object -first 1
            My-Logger "Adding ESXi host $targetVMHost to Cluster ...$orf1"
            Add-VMHost -Server $vc -Location $orf1 -User "root" -Password $VMPassword -Name $targetVMHost -Force | Out-File -Append -LiteralPath $verboseLogFile
            #Add-VMHost -Server $vc -Location (Get-Cluster -Name $NewVCVSANClusterNam3e) -User "root" -Password $VMPassword -Name $targetVMHost -Force | Out-File -Append -LiteralPath $verboseLogFile
        }
    }
    ...
    if($configureVSANDiskGroup -eq 1) {
        ...
        Get-VsanClusterConfiguration -Server $vc -Cluster $NewVCVSANClusterName1 | Set-VsanClusterConfiguration -HealthCheckIntervalMinutes 0 | Out-File -Append -LiteralPath $verboseLogFile
        Get-VsanClusterConfiguration -Server $vc -Cluster $NewVCVSANClusterName2 | Set-VsanClusterConfiguration -HealthCheckIntervalMinutes 0 | Out-File -Append -LiteralPath $verboseLogFile
        Get-VsanClusterConfiguration -Server $vc -Cluster $NewVCVSANClusterName3 | Set-VsanClusterConfiguration -HealthCheckIntervalMinutes 0 | Out-File -Append -LiteralPath $verboseLogFile
    ...
    if($configureVDS -eq 1) {
        $vds = New-VDSwitch -Server $vc  -Name $NewVCVDSName -Location (Get-Datacenter -Name $NewVCDatacenterName) -Mtu 1600 -Version 7.0.3
